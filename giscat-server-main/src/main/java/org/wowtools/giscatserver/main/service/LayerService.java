...
public class LayerService {
    ...
    public LayerService(@NotNull Layer layer) {
        this.layer = layer;
    }
     ...
     */
    public @Nullable List<Feature> query(@Nullable List<String> propertyNames, @Nullable String strExpression, @Nullable java.util.Map<String, Object> expressionParams, byte zoom) {
     ...
     * @return features 若为null则表示未找到对应的rule
     */
    public @Nullable List<Feature> nearest(@Nullable List<String> propertyNames, @Nullable String strExpression, @Nullable java.util.Map<String, Object> expressionParams, double x, double y, int n, byte zoom) {
        ArrayList expression = DataSetUtil.toJsonArray(strExpression);
        LayerDataRule rule = layer.getRule(zoom);
        if (null == rule) {
            return null;
